...
(function (exports) {
  ...
  //       showCard(article, window.data.ads[index]);
  ...
  pinMain.addEventListener('mouseup', function () {
    if (exports.map.className !== 'map') {
      ...
      // mapPins.appendChild(getDocumentFragment(window.data.ads));
  ...
  close.addEventListener('keydown', function (evt) {
    if (evt.keydown === window.card.ENTER) {
      window.card.closeOfferDialog();
    }
  });

  document.addEventListener('keydown', function (evt) {
    if (evt.keyCode === window.card.ESC) {
      window.card.closeOfferDialog();
    }
  });
  // --------------------------------------------
  ...
  buttonFormReset.addEventListener('click', function (evt) {
    evt.preventDefault();
    form.reset();
    exports.map.classList.add('map--faded');
    ...
    if (exports.map.querySelector('article')) {
